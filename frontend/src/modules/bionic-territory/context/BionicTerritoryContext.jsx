...
export const BIONIC_ACTIONS = {
  ...
  SET_CURRENT_ZOOM: 'SET_CURRENT_ZOOM',
  ...
  SET_ACTIVE_BEHAVIORS: 'SET_ACTIVE_BEHAVIORS',
  ...
  // Topographic State
  SET_TOPO_HILLSHADE: 'SET_TOPO_HILLSHADE',
  SET_TOPO_HILLSHADE_OPACITY: 'SET_TOPO_HILLSHADE_OPACITY',
  SET_TOPO_CONTOURS: 'SET_TOPO_CONTOURS',
  SET_TOPO_CONTOUR_STYLE: 'SET_TOPO_CONTOUR_STYLE',
  SET_TOPO_COLLAPSED: 'SET_TOPO_COLLAPSED',
  
  // Zone Analysis State
  SET_ZONE_ANALYSIS_ENABLED: 'SET_ZONE_ANALYSIS_ENABLED',
  SET_ZONE_ANALYSIS_WAYPOINT: 'SET_ZONE_ANALYSIS_WAYPOINT',
  SET_ZONE_ANALYSIS_AREA: 'SET_ZONE_ANALYSIS_AREA',
  SET_ZONE_ANALYSIS_RESULT: 'SET_ZONE_ANALYSIS_RESULT',
  SET_ZONE_ANALYSIS_COLLAPSED: 'SET_ZONE_ANALYSIS_COLLAPSED',
  SET_ZONE_ANALYSIS_AUTO_MODE: 'SET_ZONE_ANALYSIS_AUTO_MODE',
  
  // Species State
  SET_SELECTED_ESPECE: 'SET_SELECTED_ESPECE',
  ...
  SET_SELECTED_WAYPOINT_FOR_ZONES: 'SET_SELECTED_WAYPOINT_FOR_ZONES',
  ...
  SET_QUICK_WAYPOINT_MODE: 'SET_QUICK_WAYPOINT_MODE',
  SET_LIVE_MODE: 'SET_LIVE_MODE',
  SET_SHOW_ECOFORESTRY_PANEL: 'SET_SHOW_ECOFORESTRY_PANEL',
  SET_FOREST_LEGEND_COLLAPSED: 'SET_FOREST_LEGEND_COLLAPSED',
  
  // Dialog State
  SET_SHOW_SHARE_DIALOG: 'SET_SHOW_SHARE_DIALOG',
  SET_WAYPOINT_TO_SHARE: 'SET_WAYPOINT_TO_SHARE',
  SET_SHOW_CREATE_GROUP_DIALOG: 'SET_SHOW_CREATE_GROUP_DIALOG',
  SET_SHOW_GROUP_DASHBOARD: 'SET_SHOW_GROUP_DASHBOARD',
  SET_SELECTED_GROUP: 'SET_SELECTED_GROUP',
  SET_SHOW_ADD_PLACE_DIALOG: 'SET_SHOW_ADD_PLACE_DIALOG',
  SET_NEW_PLACE: 'SET_NEW_PLACE',
  SET_EDITING_PLACE: 'SET_EDITING_PLACE',
  SET_SHOW_ADD_WAYPOINT_DIALOG: 'SET_SHOW_ADD_WAYPOINT_DIALOG',
  SET_NEW_WAYPOINT: 'SET_NEW_WAYPOINT',
  ...
  SET_CURSOR_ELEVATION: 'SET_CURSOR_ELEVATION',
  SET_SHOW_CURSOR_INFO: 'SET_SHOW_CURSOR_INFO',
  ...
  SET_SHOW_CONCENTRIC_CIRCLES: 'SET_SHOW_CONCENTRIC_CIRCLES',
  SET_SHOW_CORRIDORS: 'SET_SHOW_CORRIDORS',
  
  // Water Exclusion
  SET_WATER_EXCLUSION_STATS: 'SET_WATER_EXCLUSION_STATS',
  SET_IS_FILTERING_WATER: 'SET_IS_FILTERING_WATER'
};
